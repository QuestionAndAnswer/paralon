...
export const methodsMap: paralon.MethodMap = {
    "get": {
        name: "get", reqType: contract.ns1.testPkg.GetRequest, resType: contract.ns1.testPkg.GetResponse
    },
    "clientStreamGet": {
        name: "clientStreamGet", reqType: contract.ns1.testPkg.GetRequest, resType: contract.ns1.testPkg.GetResponse
    },
    "serverStreamGet": {
        name: "serverStreamGet", reqType: contract.ns1.testPkg.GetRequest, resType: contract.ns1.testPkg.GetResponse
    },
    "biStreamGet": {
        name: "biStreamGet", reqType: contract.ns1.testPkg.GetRequest, resType: contract.ns1.testPkg.GetResponse
    },
    "getEmpty": {
        name: "getEmpty", reqType: contract.google.protobuf.Empty, resType: contract.google.protobuf.Empty
    },
    "clientStreamGetEmpty": {
        name: "clientStreamGetEmpty", reqType: contract.google.protobuf.Empty, resType: contract.google.protobuf.Empty
    },
    "serverStreamGetEmpty": {
        name: "serverStreamGetEmpty", reqType: contract.google.protobuf.Empty, resType: contract.google.protobuf.Empty
    },
    "biStreamGetEmpty": {
        name: "biStreamGetEmpty", reqType: contract.google.protobuf.Empty, resType: contract.google.protobuf.Empty
    },
}

export interface ISkillsService extends paralon.IProtoService {
...
export class ServerBridge implements paralon.IServerBridge {
    constructor (
        ...
        private readonly transport: paralon.IServerTransport
    ) {}
    ...
    public register () {
        ...
        this.transport.registerServerStreamImpl(
            methodsMap["serverStreamGet"], 
            this.serverImpl["serverStreamGet"].bind(this)
        );
        this.transport.registerBiStreamImpl(
            methodsMap["biStreamGet"],
            this.serverImpl["biStreamGet"].bind(this)
        );
        this.transport.registerCallImpl(
            methodsMap["getEmpty"], 
        ...
        this.transport.registerBiStreamImpl(
            methodsMap["biStreamGetEmpty"],
            this.serverImpl["biStreamGetEmpty"].bind(this)
        );
    }
}

export class Client implements paralon.IClient, ISkillsService {
    constructor (
        private readonly transport: paralon.IClientTransport
    ) {}
    ...
    serverStreamGet (request: contract.ns1.testPkg.GetRequest): paralon.MessageReadStream {
        return this.transport.serverStreamImpl(methodsMap["serverStreamGet"], request);
    }
    biStreamGet (request: paralon.MessageReadStream<contract.ns1.testPkg.GetRequest>): paralon.MessageReadStream {
